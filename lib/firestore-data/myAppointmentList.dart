...
import 'package:health_and_doctor_appointment/screens/getPrescription.dart';
  ...
  showAlertDialog(BuildContext context) {
    ...
    Widget continueButton = TextButton(
      ...
      onPressed: () {
        ...
        deleteAppointmentDoc(_documentID);
        Navigator.of(context).pop();
      },
    );
                                  ...
                                  IconButton(
                                    ...
                                    onPressed: () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => GetPrescription(
                                            docID: document.id,
                                            patientName: document['name'],
                                          ),
                                        ),
                                      );
                                    },
