...
class DocPrevAppointments extends StatefulWidget {
  @override
  _DocPrevAppointmentsState createState() => _DocPrevAppointmentsState();
}

class _DocPrevAppointmentsState extends State<DocPrevAppointments> {
